...
const app = new (0, _controllerJsDefault.default)();
app.init();

},{"./controller.js":"aenu9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aenu9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Controller {
    constructor(){
        ...
        this.view = new (0, _viewJsDefault.default)({
...
},{"./model.js":"Y4A21","./api.js":"9u7qN","./view.js":"ky8MP","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"Y4A21":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Model {
    ...
    setMemeImg(id) {
        this.memeID = id;
        for (const meme of this.memes[0].data.memes)if (this.memeID == meme.id) {
...
class View {
    constructor({ onMemeImgChange }){
        ...
        // DOM Elements
        this.selectMemeNameNode = document.getElementById("js-select-meme-name__block");
        ...
        this.inputBottomTextNode = document.getElementById("js-select-meme__text-bottom");
        ...
        this.memeImageBottomTextNode = document.getElementById("img-block__text-bottom");
        ...
        this.memeBottomTextColorNode = document.getElementById("js-text-color__bottom");
        this.inputTopLengthValidationNode = document.querySelector(".length-validation__top");
        this.inputBottomLengthValidationNode = document.querySelector(".length-validation__bottom");
        // Event Listeners
        ...
        this.inputBottomTextNode.addEventListener("input", this.handleInputTextBottom);
    ...
    handleInputTextTop = ()=>{
        ...
        if (this.inputTopTextNode.value.length > 49) {
            this.inputTopLengthValidationNode.classList.add("length-validation_active");
            this.inputTopLengthValidationNode.innerText = "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u0442\u0435\u043A\u0441\u0442\u0430 50 \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432";
        } else {
            this.inputTopLengthValidationNode.classList.remove("length-validation_active");
    ...
    handleInputTextBottom = ()=>{
        ...
        if (this.inputBottomTextNode.value.length > 49) {
            this.inputBottomLengthValidationNode.classList.add("length-validation_active");
            this.inputBottomLengthValidationNode.innerText = "\u041C\u0430\u043A\u0441\u0438\u043C\u0430\u043B\u044C\u043D\u0430\u044F \u0434\u043B\u0438\u043D\u0430 \u0442\u0435\u043A\u0441\u0442\u0430 50 \u0441\u0438\u043C\u0432\u043E\u043B\u043E\u0432";
        } else {
            this.inputBottomLengthValidationNode.classList.remove("length-validation_active");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l9Mez","ebWYT"], "ebWYT", "parcelRequire716c")
